...
rem obtain Pokemon 1 data from filePath_player1
...
for /f "tokens=3 delims=," %%A in (%filePath_player1%) do (set hp_iv_pokemon1=%%A)
for /f "tokens=4 delims=," %%A in (%filePath_player1%) do (set atk_iv_pokemon1=%%A)
for /f "tokens=5 delims=," %%A in (%filePath_player1%) do (set def_iv_pokemon1=%%A)
for /f "tokens=6 delims=," %%A in (%filePath_player1%) do (set spd_iv_pokemon1=%%A)
for /f "tokens=7 delims=," %%A in (%filePath_player1%) do (set spc_iv_pokemon1=%%A)
...
for /f "tokens=12 delims=," %%A in (%filePath_player1%) do (set move3No_pokemon1=%%A)
for /f "tokens=13 delims=," %%A in (%filePath_player1%) do (set move4No_pokemon1=%%A)

rem obtain pokemon 1 base stats
for /f "tokens=3 delims=, skip=%dexNo_pokemon1%" %%A in (data\pokemonStats.txt) do (
	set hp_base_pokemon1=%%A
	goto 1next1
)
:1next1
for /f "tokens=4 delims=, skip=%dexNo_pokemon1%" %%A in (data\pokemonStats.txt) do (
	set atk_base_pokemon1=%%A
	goto 1next2
)
:1next2
...
rem Obtain Pokemon 2 data from filePath_player2
...
set /a "atk_pokemon1=((((atk_base_pokemon1+atk_iv_pokemon1)*2)*lvl_pokemon1)/100)+5"
set /a "def_pokemon1=((((def_base_pokemon1+def_iv_pokemon1)*2)*lvl_pokemon1)/100)+5"
set /a "spd_pokemon1=((((spd_base_pokemon1+spd_iv_pokemon1)*2)*lvl_pokemon1)/100)+5"
set /a "spc_pokemon1=((((spc_base_pokemon1+spc_iv_pokemon1)*2)*lvl_pokemon1)/100)+5"
